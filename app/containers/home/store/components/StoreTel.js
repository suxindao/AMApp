...
import { loadData, setState, rsetState } from '../../../../redux/modules/home/store/basicStoreInfoRedux'
...
class StoreTel extends Component{
  constructor(props){
    super(props)
      ...
      storeTelTag.push(
        ...
        >
          <ContentComponent
            ...
            callback={data=>{this.modifyStoreTel(data, store_tel_data[index].key)}}
          />
          {
            this.props.editable?
              <TouchableOpacity
...
export default connect(mapStateToProps, mapDispatchToProps)(StoreTel)