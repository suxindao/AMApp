...
import {loadMoreData, reloadData} from '../../../../redux/modules/home/order/referOrderListReducer'
...
const mapStateToProps = state => ({
    list_loading: state.referOrderList.list_loading,
    list_refresh: state.referOrderList.list_refresh,
    list_error: state.referOrderList.list_error
})
...
class Page extends Component {
    ...
    async _getMore() {
        try {
            let newBody = _.cloneDeep(this.props.body)
            newBody.page.next_key = Boolean(this.data.next_key) ? this.data.next_key : ''
